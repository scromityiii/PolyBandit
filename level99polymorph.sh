...
if [ "$changer" == "1" ] || [ "$changer" == "2" ] || [ "$changer" == "3" ] || [ "$changer" == "4" ]
	...
	textfilename="me me.txt"
		...
		then 
		    bashfiletext="#the line below me blockades your path" #level99d
	...
	textfilename="in hereplease.txt"
		...
		then
		    bashfiletext="#eliminate the line below me (exit) and your way will be clear" #level99f
       ...
       textfilename="thisis it.txt"
		...
		then
		    bashfiletext="#if this next line is not deleted you won't proceed" #level99g
       ...
       textfilename="aperto aperto.txt"
		...
		then 
		    bashfiletext="#eliminate the line below and you shall pass" #level99h
	...
	textfilename="youare worthy.txt"
		...
		then 
		    bashfiletext="#delete the line that is below it makes the account log out" #level99i
		...
		then 
		    bashfiletext="#in the line below this lies your obstacle to logging into this account" #level99l
		...
		then
		    bashfiletext="#in the next line is what blocks, it makes the account logout" #level99m
		...
		then
		    bashfiletext="#eliminate the next line, below, and you shall pass" #level99n
		...
		then
		    bashfiletext="#in the line below this lies a statement that causes this account to fail, delete it" #level99o
...
sed -i '1s/^/'"$bashfiletext"' /' /home/level99/.bashrc;
sed -i '2s/^/exit /' /home/level99/.bashrc;
