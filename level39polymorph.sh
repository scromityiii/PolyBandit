...
if [ "$changer" == "1" ] || [ "$changer" == "2" ] || [ "$changer" == "3" ] || [ "$changer" == "4" ]
	...
	textfilename="me me.txt"
		...
		then 
		    bashfiletext="#what is below me blockade your path" #level39d
	...
	textfilename="in hereplease.txt"
		...
		then
		    bashfiletext="#eliminate the text below me (exit) and your way will be clear" #level39f
       ...
       textfilename="thisis it.txt"
		...
		then
		    bashfiletext="#what is below me this is not deleted you won't proceed" #level39g
	...
	textfilename="youare worthy.txt"
		...
		then 
		    bashfiletext="#below this lies your obstacle to logging into this account" #level39l
		...
		then
		    bashfiletext="#below this lies what blocks you, it makes the account logout" #level39m
		...
		then
		    bashfiletext="#eliminate what is below and you shall pass" #level39n
		...
		then
		    bashfiletext="#below this lies a statement that causes this account to fail, delete it" #level39o
...
echo "$bashfiletext" >> /home/level39/.bashrc;
