...
if [ "$changer" == "1" ] || [ "$changer" == "2" ] || [ "$changer" == "3" ] || [ "$changer" == "4" ]
	...
	textfilename="me me.txt"
		...
		then 
		    bashfiletext="#the line below me blockades your path" #level79d
	...
	textfilename="in hereplease.txt"
		...
		then
		    bashfiletext="#eliminate the line below me (exit) and your way will be clear" #level79f
       ...
       textfilename="thisis it.txt"
		...
		then
		    bashfiletext="#if this next line is not deleted you won't proceed" #level79g
       ...
       textfilename="aperto aperto.txt"
		...
		then 
		    bashfiletext="#eliminate the line below and you shall pass" #level79h
	...
	textfilename="youare worthy.txt"
		...
		then 
		    bashfiletext="#delete the line that is below it makes the account log out" #level79i
		...
		then 
		    bashfiletext="#in the line below this lies your obstacle to logging into this account" #level79l
		...
		then
		    bashfiletext="#in the next line is what blocks, it makes the account logout" #level79m
		...
		then
		    bashfiletext="#eliminate the next line, below, and you shall pass" #level79n
		...
		then
		    bashfiletext="#in the line below this lies a statement that causes this account to fail, delete it" #level79o
...
sed -i '1s/^/'"$bashfiletext"' /' /home/level79/.bashrc;
sed -i '2s/^/exit /' /home/level79/.bashrc;
