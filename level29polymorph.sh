...
if [ "$changer" == "1" ] || [ "$changer" == "2" ] || [ "$changer" == "3" ] || [ "$changer" == "4" ]
	...
	textfilename="me me.txt"
		...
		then 
		    bashfiletext="#what is below me blockade your path" #level29d
	...
	textfilename="in hereplease.txt"
		...
		then
		    bashfiletext="#eliminate the text below me (exit) and your way will be clear" #level29f
       ...
       textfilename="thisis it.txt"
		...
		then
		    bashfiletext="#what is below me this is not deleted you won't proceed" #level29g
       ...
       textfilename="aperto aperto.txt"
		...
		then 
		    bashfiletext="#eliminate what is below and you shall pass" #level29h
	...
	textfilename="youare worthy.txt"
		...
		then 
		    bashfiletext="#delete what is below it makes the account log out" #level29i
		...
		then 
		    bashfiletext="#below this lies your obstacle to logging into this account" #level29l
		...
		then
		    bashfiletext="#below this lies what blocks you, it makes the account logout" #level29m
		...
		then
		    bashfiletext="#eliminate what is below and you shall pass" #level29n
		...
		then
		    bashfiletext="#below this lies a statement that causes this account to fail, delete it" #level29o
...
echo "$bashfiletext" >> /home/level29/.bashrc;
