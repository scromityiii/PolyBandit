...
if [ "$changer" == "1" ] || [ "$changer" == "2" ] || [ "$changer" == "3" ] || [ "$changer" == "4" ]
       ...
       textfilename="userdirectory.txt"
		...
		then
		    hint2="tomyleftorrightudududududee" #level43b
	...
	textfilename="megacorplist.txt"
		...
		then
		    hint2="navigateogreatone" #level43f
...
declare -a users=("aeijdoifj" "boidsjoi" "8327cdkjc" "h923878d" "ei4378y7" "897ydfuf" "diufh78g" "94yf7hh" "498fuyu897i" "984fy78j" "k94fy9874fh" "l849fy9874" "98uf498m" "984fy978n" "oidusufhu" "poidsjfui" "qoifjoi" "r98r34894" "s9dusfh897" "t984fu98" "984f98u" "984fu89v" "w984jf98" "x9874fh89" "y984f89" "z984hf9874" "Aiudcvh874" "aueriufh879B" "0984fju89C" "9487f7h87D" "oisfhj879E" "Fdsfhf984" "Giu4fh7" "H984fjh984" "Infu4rh8" "J43f89jh489" "Kudisfhiu4" "L9hf4879" "M984fh7u" "N94ufhj89" "O4ofij48" "P49fj89" "4fh48u9uQ" "4f49ufhR" "4fh48yfhgS" "f4hbf84T" "4f4ffU" "Vdf4" "a43frW" "sfX" "c4f4f4Y" "aef44Z" "14f4qaf4" "4af4a4f2" "esfa3" "242344" "2344325" "64234" "24237" "823432" "9546" "543630");		
		...
		then
		    hint2="tomyleftorright" #level43o
...
declare -a users=("aeijdoifj" "boidsjoi" "8327cdkjc" "h923878d" "ei4378y7" "897ydfuf" "diufh78g" "94yf7hh" "498fuyu897i" "984fy78j" "k94fy9874fh" "l849fy9874" "98uf498m" "984fy978n" "oidusufhu" "poidsjfui" "qoifjoi" "r98r34894" "s9dusfh897" "t984fu98" "984f98u" "984fu89v" "w984jf98" "x9874fh89" "y984f89" "z984hf9874" "Aiudcvh874" "aueriufh879B" "0984fju89C" "9487f7h87D" "oisfhj879E" "Fdsfhf984" "Giu4fh7" "H984fjh984" "Infu4rh8" "J43f89jh489" "Kudisfhiu4" "L9hf4879" "M984fh7u" "N94ufhj89" "O4ofij48" "P49fj89" "4fh48u9uQ" "4f49ufhR" "4fh48yfhgS" "f4hbf84T" "4f4ffU" "Vdf4" "a43frW" "sfX" "c4f4f4Y" "aef44Z" "14f4qaf4" "4af4a4f2" "esfa3" "242344" "2344325" "64234" "24237" "823432" "9546" "543630");	
		...
		touch /home/level43/oneline.txt;
		touch /home/level43/"$textfilename";
		...
		do
		  ...
		  then
		    ...
		    hint=${hint2};
		    rand_pass=${hint}" "" "" "${level44_pass};
		    echo $rand_pass > /home/level43/oneline.txt;
		    cat /home/level43/"$textfilename" /home/level43/oneline.txt > /home/level43/"$textfilename2";
		    rm /home/level43/"$textfilename";
		    mv /home/level43/"$textfilename2" /home/level43/"$textfilename"
		    count=$((count+1));
		  else
		...
		rand_pass2=${users[$user1]}" "" "" "${users[$user2]};
		    echo $rand_pass2 > /home/level43/oneline.txt;
		    cat /home/level43/"$textfilename" /home/level43/oneline.txt > /home/level43/"$textfilename2";
		    rm /home/level43/"$textfilename";
		    mv /home/level43/"$textfilename2" /home/level43/"$textfilename";
		    count=$(($count+1));
...
echo "* This is within the text file "$textfilename"                                    *" >> /home/level43/README.txt;
...
echo "***********************************************************************************" >> /home/level43/README.txt;
		...
		chown level43:level43 /home/level43/README.txt;

#chown level0: /home/level1;
#chmod -rwxr-x--- /home/level1;
#This block prevents the host system's user (the one that executes PolyBandit) as well as anybody other than the level itself from being able to read into 
#this level's directory and its subdirectories. In essence, no cheating, you must play the game in order, and you cannot tamper with any game files unless they are in
#the level you are currently in. The first for loop sets permissions on users before level43. The second sets them on all users after. None except level43 will be able to view the contents of /home/level43
#until they have ssh'd into it properly. Permissions are set to block others from reading and writing to level43.

setfacl -m u:level43:r-x /home/level43;
...
find /home/level43 -type f -exec setfacl -m u:$level:--x {} \;
find /home/level43 -type d -exec setfacl -m u:$level:--x {} \;
...
setfacl -m u:$USER:--x /home/level43;