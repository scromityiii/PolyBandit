...
if [ "$changer" == "1" ]
       ...
       textfilename="please me.txt"
		...
		then
		    bashfiletext="#this next line will make the account logout and go kaput" #level3b
	...
	textfilename="open thisone.txt"
		...
		then
		    bashfiletext="#this next line is why you can't proceed into this account" #level3c
	...
	textfilename="me me.txt"
		...
		then 
		    bashfiletext="#what is below me blockade your path" #level3d
	...
	textfilename="in here.txt"
		...
		then 
		    bashfiletext="#destroy the line below me" #level3e
	...
	textfilename="in hereplease.txt"
		...
		then
		    bashfiletext="#eliminate the text below me (exit) and your way will be clear" #level3f
       ...
       textfilename="thisis it.txt"
		...
		then
		    bashfiletext="#what is below me this is not deleted you won't proceed" #level3g
       ...
       textfilename="aperto aperto.txt"
		...
		then 
		    bashfiletext="#eliminate what is below and you shall pass" #level3h
	...
	textfilename="youare worthy.txt"
		...
		then 
		    bashfiletext="#delete what is below it makes the account log out" #level3i
		...
		then
		    bashfiletext="#want to pass? delete exit, it makes the account log out" #level3j
		...
		then
		    bashfiletext="#the line below immidiately causes the account to log out" #level3k
		...
		then 
		    bashfiletext="#below this lies your obstacle to logging into this account" #level3l
		...
		then
		    bashfiletext="#below this lies what blocks you, it makes the account logout" #level3m
		...
		then
		    bashfiletext="#eliminate what is below and you shall pass" #level3n
		...
		then
		    bashfiletext="#below this lies a statement that causes this account to fail, delete it" #levelo
		...
		then
		    bashfiletext="#delete the line below this" #level3p
